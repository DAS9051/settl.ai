    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md hover:border-blue-200 transition-all">
      <div className="flex items-start justify-between gap-4 mb-3">
        <div>
          ...
          {job.business_name && (
            <p className="text-sm text-blue-700 font-medium mt-0.5">{job.business_name}</p>
          )}
        </div>
        {job.verified && (
      ...
      <p className="text-sm text-gray-600 leading-relaxed line-clamp-3 mb-4">{job.description}</p>
